function iono = iri2020(time, glat, glon, altkm_range)
arguments
  time (1,1) datetime
...
srcdir = fullfile(cwd, "../src/iri2020");
exe = fullfile(srcdir, "iri2020_driver");
if ispc
  exe = exe + ".exe";
end
if ~isfile(exe)
...
assert(isfile(exe), 'could not build or find iri2020 executable: %s', exe)

datadir = fullfile(cwd, "../src/iri2020/data");
