function iono = iri2026(time, glat, glon, altkm_range)
arguments
  time (1,1) datetime
...
srcdir = fullfile(cwd, "../src/iri2026");
exe = fullfile(srcdir, "iri2026_driver");
if ispc
  exe = exe + ".exe";
end
if ~isfile(exe)
...
assert(isfile(exe), 'could not build or find iri2026 executable: %s', exe)

datadir = fullfile(cwd, "../src/iri2026/data");
