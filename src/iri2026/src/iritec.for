...
C 2020.03 03/25/25 ******** released on irimodel.org *************
C 2020.04 09/22/25 IRITEC: deleting JFF                     [M.-Y. Chou] 
C 2020.04 09/25/25 ******** released on irimodel.org *************
C
c-----------------------------------------------------------------------        
C
C
...
c		
	do j=1,iisect
     ...
     &        abeg,aend,hstep,OUTF,OARR,datadir1)
	  if(j.lt.2) then
            hmF2 = oarr(2)
            xnmF2 = oarr(1)
            xnorm = xnmF2/1000.
